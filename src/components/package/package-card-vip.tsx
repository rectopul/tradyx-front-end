...
export const PackageCardVip = ({ pkg }: PackageCardProps) => {
    ...
    return (
        <>
            <div
                className="rounded-xl py-4 flex flex-col h-[193px] font-avenir bg-top bg-cover bg-no-repeat shadow-md relative"
                style={{
                    backgroundImage: `url(${asset("/" + pkg.photo)})`,
                }}
            >
                <span className="absolute right-2 -top-4 text-white h-[40px] gap-1 p-2 bg-pacific-blue-500 rounded-full flex justify-center items-center">
                    <Diamond className="w-[26px] h-[26px]" />
                    <span className="font-bold italic">VIP</span>
                </span>

                <span className="absolute left-2 z-10 uppercase text-xxs shadow-md -top-4 h-[20px] leading-tight font-semibold gap-1 p-2 bg-gradient-to-b from-orange-600 to-orange-400 text-white rounded-full flex justify-center items-center">
                    Limitado
                </span>
                ...
                <div className="w-full h-28 px-4 text-[16px] relative gap-1 justify-center mt-5 flex flex-col text-white font-bold bg-gradient-to-r from-black from-10% to-transparent to-80%">
                    <div className="text-yellow-400 text-sm font-semibold">
                        {parseInt("" + pkg.commission_percentage)}%{" "}
                        <span className="text-white font-normal">/ Ao dia</span>
                    </div>
