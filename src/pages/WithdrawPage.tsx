    ...
    return (
        <div className="w-full flex flex-col font-sans px-2 mb-24">
            <div className="mt-6 flex flex-col gap-1">
                <h2 className="text-2xl font-bold text-gray-900">Sacar Fundos</h2>
                <p className="text-sm text-gray-400 font-medium">
                    Disponível para saque: <span className="text-gray-900 font-bold">{formatCurrency(user.available_to_withdraw)}</span>
                </p>
            </div>
            ...
            >
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-bold text-gray-900 ml-1">Valor do Saque</label>
                ...
                <div className="bg-brand/5 border border-brand/10 rounded-2xl p-4 flex items-start gap-3">
                    ...
                    <p className="text-xs text-brand/80 font-medium leading-relaxed">
                        O valor mínimo para saque é {formatCurrency(settings?.minimum_withdraw ?? 0)}.
                    </p>
                </div>
                ...
                >
                    <Pix className="w-6 h-6" /> Sacar via Pix
                </button>
                ...
                <div className="w-full bg-white rounded-3xl shadow-sm border border-gray-100 p-6 space-y-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-gray-900 font-bold">Informações Importantes</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex gap-3">
                            ...
                            <p className="text-xs text-gray-500 leading-relaxed">
                                Verifique se o valor do saque está correto. Saques abaixo do mínimo
                        ...
                        <div className="flex gap-3">
                            ...
                            <p className="text-xs text-gray-500 leading-relaxed">
                                Sempre crie uma nova solicitação de saque na plataforma {settings?.site_name} para cada transação.
                            </p>
                        </div>
                        <div className="flex gap-3">
                            <span className="text-brand font-bold">03.</span>
                            <p className="text-xs text-gray-500 leading-relaxed">
                                Os saques são processados em até 1 hora. Se não receber em 3 horas, entre em contato com o suporte.
                            </p>
                        </div>
                    </div>
                </div>
